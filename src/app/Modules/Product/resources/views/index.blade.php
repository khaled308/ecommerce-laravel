            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('products.create') }}" class="btn btn-primary btn-sm ms-auto">Create Product</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="{{ $loop->even ? 'even' : 'odd' }}">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#"
                                                        class="btn btn-danger btn-sm product-delete">Delete</a>
...
<script>
   document.querySelectorAll('.product-delete').forEach(function (element) {
