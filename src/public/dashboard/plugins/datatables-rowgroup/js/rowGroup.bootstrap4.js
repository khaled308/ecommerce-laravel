 ...
 */
(function(factory){if(typeof define==='function'&&define.amd){define(['jquery','datatables.net-bs4','datatables.net-rowgroup'],function($){return factory($,window,document);});}
